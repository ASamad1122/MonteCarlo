...
def monte_carlo_simulation(starting_price, num_simulations, num_days, revenue_growth_range, operating_margin_range, capital_ratio_range, cost_of_capital_range):
    ...
    for i in range(1, num_days):
        # Generate random numbers from uniform distributions
...
revenue_growth_range = (-0.0001, 0.001)  # Uniform distribution for daily revenue growth
operating_margin_range = (-0.0005, 0.002)  # Uniform distribution for daily operating margin
capital_ratio_range = (-0.0002, 0.001)  # Uniform distribution for daily capital ratio
cost_of_capital_range = (-0.0001, 0.0005)  # Uniform distribution for daily cost of capital
...
plt.title('Monte Carlo Simulation of Daily Stock Prices with Variable Factors')
plt.xlabel('Days')
